...
TREZOR_FIRMWARE_VERSION = 77d3264b3ca48d794acda76887740232d49acd4b
...
TREZOR_FIRMWARE_DEPENDENCIES = python3 host-python3
...
define TREZOR_FIRMWARE_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_PITLAB_WALLET_PATH)/package/trezor-firmware/trezor-emu.service \
